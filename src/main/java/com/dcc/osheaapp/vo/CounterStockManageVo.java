...
@Entity
@Table(name = "counter_stock_manage") // Pocket MIS
@EntityListeners(AuditingEntityListener.class)
public class CounterStockManageVo implements Serializable, Cloneable {
	...
	public CounterStockManageVo() {
	}

	public CounterStockManageVo(OutletVo outlet, ProductVo productId, Long openingStock, Long purchase, Long sale,
	...
	public CounterStockManageVo setId(Long id) {
		this.id = id;
		return this;
	}
	...
	public CounterStockManageVo setOutlet(OutletVo outlet) {
		this.outlet = outlet;
		return this;
	}
	...
	public CounterStockManageVo setProductId(ProductVo productId) {
		this.productId = productId;
		return this;
	}
	...
	public CounterStockManageVo setOpeningStock(Long openingStock) {
		this.openingStock = openingStock;
		return this;
	}
	...
	public CounterStockManageVo setPurchase(Long purchase) {
		this.purchase = purchase;
		return this;
	}
	...
	public CounterStockManageVo setSale(Long sale) {
		this.sale = sale;
		return this;
	}
	...
	public CounterStockManageVo setDamage(Long damage) {
		this.damage = damage;
		return this;
	}
	...
	public CounterStockManageVo setPurchaseReturn(Long purchaseReturn) {
		this.purchaseReturn = purchaseReturn;
		return this;
	}
	...
	public CounterStockManageVo setSaleReturn(Long saleReturn) {
		this.saleReturn = saleReturn;
		return this;
	}
	...
	public CounterStockManageVo setClosingStock(Long closingStock) {
		this.closingStock = closingStock;
		return this;
	}
	...
	public CounterStockManageVo setOpeningStockAmount(String openingStockAmount) {
		this.openingStockAmount = openingStockAmount;
		return this;
	}
	...
	public CounterStockManageVo setPurchaseAmount(String purchaseAmount) {
		this.purchaseAmount = purchaseAmount;
		return this;
	}
	...
	public CounterStockManageVo setSaleAmount(String saleAmount) {
		this.saleAmount = saleAmount;
		return this;
	}
	...
	public CounterStockManageVo setDamageAmount(String damageAmount) {
		this.damageAmount = damageAmount;
		return this;
	}
	...
	public CounterStockManageVo setPurchaseReturnAmount(String purchaseReturnAmount) {
		this.purchaseReturnAmount = purchaseReturnAmount;
		return this;
	}
	...
	public CounterStockManageVo setSaleReturnAmount(String saleReturnAmount) {
		this.saleReturnAmount = saleReturnAmount;
		return this;
	}
	...
	public CounterStockManageVo setClosingStockAmount(String closingStockAmount) {
		this.closingStockAmount = closingStockAmount;
		return this;
	}
	...
	public CounterStockManageVo setUpdateType(String updateType) {
		this.updateType = updateType;
		return this;
	}
	...
	public CounterStockManageVo setCategoryName(String categoryName) {
		this.categoryName = categoryName;
		return this;
	}
	...
	public CounterStockManageVo setSubCategoryName(String subCategoryName) {
		this.subCategoryName = subCategoryName;
		return this;
	}
	...
	public CounterStockManageVo setCreatedOn(Date createdOn) {
		this.createdOn = createdOn;
		return this;
	}
	...
	public CounterStockManageVo setCreatedBy(Long createdBy) {
		this.createdBy = createdBy;
		return this;
	}
	...
	public CounterStockManageVo setUpdatedOn(Date updatedOn) {
		this.updatedOn = updatedOn;
		return this;
	}
	...
	public CounterStockManageVo setUpdatedBy(Long updatedBy) {
		this.updatedBy = updatedBy;
		return this;
	}
	...
	public CounterStockManageVo setAdjustedOn(Date adjustedOn) {
		this.adjustedOn = adjustedOn;
		return this;
	}
	...
	public CounterStockManageVo setAdjustedBy(Long adjustedBy) {
		this.adjustedBy = adjustedBy;
		return this;
	}
	...
	public CounterStockManageVo setAdjustedNoOfPcs(Long adjustedNoOfPcs) {
		this.adjustedNoOfPcs = adjustedNoOfPcs;
		return this;
	}
	...
	public CounterStockManageVo setAdjustedAmount(Double adjustedAmount) {
		this.adjustedAmount = adjustedAmount;
		return this;
	}
	...
	public CounterStockManageVo setTransactionDate(Date transactionDate) {
		this.transactionDate = transactionDate;
		return this;
	}
	...
	public String toString() {
		return "CounterStockManageVo [id=" + id + ", outlet=" + outlet + ", productId=" + productId + ", openingStock="
	...
	public static CounterStockManageVoBuilder builder() {
		return new CounterStockManageVoBuilder();
	}

	public static class CounterStockManageVoBuilder {
		private OutletVo outlet;
		private ProductVo productId;
		...
		public CounterStockManageVoBuilder() {
		}

		public CounterStockManageVoBuilder outlet(OutletVo outlet) {
			this.outlet = outlet;
			return this;
		}

		public CounterStockManageVoBuilder productId(ProductVo productId) {
			this.productId = productId;
			return this;
		}

		public CounterStockManageVoBuilder openingStock(Long openingStock) {
			this.openingStock = openingStock;
			return this;
		}

		public CounterStockManageVoBuilder purchase(Long purchase) {
			this.purchase = purchase;
			return this;
		}

		public CounterStockManageVoBuilder sale(Long sale) {
			this.sale = sale;
			return this;
		}

		public CounterStockManageVoBuilder closingStock(Long closingStock) {
			this.closingStock = closingStock;
			return this;
		}

		public CounterStockManageVoBuilder openingStockAmount(String openingStockAmount) {
			this.openingStockAmount = openingStockAmount;
			return this;
		}

		public CounterStockManageVoBuilder purchaseAmount(String purchaseAmount) {
			this.purchaseAmount = purchaseAmount;
			return this;
		}

		public CounterStockManageVoBuilder saleAmount(String saleAmount) {
			this.saleAmount = saleAmount;
			return this;
		}

		public CounterStockManageVoBuilder closingStockAmount(String closingStockAmount) {
			this.closingStockAmount = closingStockAmount;
			return this;
		}

		public CounterStockManageVoBuilder updateType(String updateType) {
			this.updateType = updateType;
			return this;
		}

		public CounterStockManageVoBuilder categoryName(String categoryName) {
			this.categoryName = categoryName;
			return this;
		}

		public CounterStockManageVoBuilder subCategoryName(String subCategoryName) {
			this.subCategoryName = subCategoryName;
			return this;
		}

		public CounterStockManageVoBuilder createdOn(Date createdOn) {
			this.createdOn = createdOn;
			return this;
		}

		public CounterStockManageVoBuilder createdBy(Long createdBy) {
			this.createdBy = createdBy;
			return this;
		}

		public CounterStockManageVoBuilder updatedOn(Date updatedOn) {
			this.updatedOn = updatedOn;
			return this;
		}

		public CounterStockManageVoBuilder updatedBy(Long updatedBy) {
			this.updatedBy = updatedBy;
			return this;
		}

		public CounterStockManageVoBuilder purchaseReturn(Long purchaseReturn) {
			this.purchaseReturn = purchaseReturn;
			return this;
		}

		public CounterStockManageVoBuilder saleReturn(Long saleReturn) {
			this.saleReturn = saleReturn;
			return this;
		}

		public CounterStockManageVoBuilder purchaseReturnAmount(String purchaseReturnAmount) {
			this.purchaseReturnAmount = purchaseReturnAmount;
			return this;
		}

		public CounterStockManageVoBuilder saleReturnAmount(String saleReturnAmount) {
			this.saleReturnAmount = saleReturnAmount;
			return this;
		}

		public CounterStockManageVoBuilder damage(Long damage) {
			this.damage = damage;
			return this;
		}

		public CounterStockManageVoBuilder damageAmount(String damageAmount) {
			this.damageAmount = damageAmount;
			return this;
		}

		public CounterStockManageVoBuilder transactionDate(Date transactionDate) {
			this.transactionDate = transactionDate;
			return this;
		}
		
		public CounterStockManageVo build() {
			return new CounterStockManageVo(outlet, productId, openingStock, purchase, sale, damage, purchaseReturn,
